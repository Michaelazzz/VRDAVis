...
// void HttpServer::OnConnect(uWS::WebSocket<false, true, vrdavis::HttpServer::PerSocketData> *ws) {
//     std::cout << "Client Connected" << std::endl;
// }

// void HttpServer::OnMessage(uWS::WebSocket<false, true, vrdavis::HttpServer::PerSocketData> *ws, std::string_view message, uWS::OpCode opCode) {
//     std::cout << message << std::endl;
// }
