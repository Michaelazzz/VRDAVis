#ifndef VRDAVIS_BACKEND_LOGGER_LOGGER_H_
#define VRDAVIS_BACKEND_LOGGER_LOGGER_H_
...
#define VRDAVIS_LOGGER_TAG "VRDAVis"
#define VRDAVIS_LOGGER_PATTERN "[%Y-%m-%d %H:%M:%S.%e] [%^%l%$] %v"
#define PERF_TAG "performance"
#define PERF_PATTERN "[%Y-%m-%d %H:%M:%S.%e] [%^%l%$] [%n] %v"

// customise the log function for performance
namespace spdlog {
...
*/
class vrdavis_sink : public ansicolor_sink<details::console_mutex> {
public:
    vrdavis_sink()
...
#endif //VRDAVIS_BACKEND_LOGGER_LOGGER_H_